    ...
    <div class="container">
      ...
      <form class="" action="/regist_check" method="post">
        <div class="input-group form-inline text-center">
          <span class="input-group-addon" id="uID">ユーザID：</span>
        ...
        <span class="input-group-addon" id="uMail">Mail address:</span>
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="パスワード" aria-describedby="pass" name="regist_uPass">
        </div>

        <br><br>
        <div class="row">
          <form action="/index">
            <button type="submit" class="btn btn-danger btn-group" role="button">              取り消して戻る</button>

          </form>
          
          <button type="submit"  class="btn btn-succe btn-group" role="button">確認</button>
